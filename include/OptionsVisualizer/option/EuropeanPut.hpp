...
template <typename T>
class EuropeanPut : public Option<T> {
public:
    EuropeanPut(utils::type::ParamT<T> S, utils::type::ParamT<T> K, utils::type::ParamT<T> r, utils::type::ParamT<T> q,
    ...
    void calcPrice() override {
        this->p_ = pricing::bsmPut<T>(this->S_, this->K_, this->r_, this->q_, this->sigma_, this->T_exp_);
    }
};
