...
#include "OptionsVisualizer/option/Put.hpp"
#include "OptionsVisualizer/utils/typing.hpp"

namespace Option {

template <typename T>
class AmericanPut : public Option<T> {
    static constexpr Payoff::Put<T> payoff{};

public:
    AmericanPut(utils::type::ParamT<T> S, utils::type::ParamT<T> K, utils::type::ParamT<T> r, utils::type::ParamT<T> q,
