...
struct Params {
  ...
  Params(Eigen::DenseIndex nSigma_, Eigen::DenseIndex nStrike_, double spot_,
         double r_, double q_, double sigmaLo_, double sigmaHi_,
         double strikeLo_, double strikeHi_, double tau_);
