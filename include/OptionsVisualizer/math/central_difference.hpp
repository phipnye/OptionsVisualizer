 ...
 */
template <typename T>
T cdmFirstOrder(utils::type::ParamT<T> priceLo, utils::type::ParamT<T> priceHi, utils::type::ParamT<T> epsilon) {
 ...
 */
template <typename T>
T cmdSecondOrder(utils::type::ParamT<T> priceLo, utils::type::ParamT<T> priceBase, utils::type::ParamT<T> priceHi,
